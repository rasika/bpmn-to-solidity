Property Rental Paper Contract

Link: https://medium.com/@naqvi.jafar91/converting-a-property-rental-paper-contract-into-a-smart-contract-daa054fdf8a7
...
```
sequenceDiagram
    Landlord ->> Contract: Deploy the Rental Agreement
    Contract-->>Contract: Change State: Created 
    Tenant->> Contract: Confirm Agreement
    Contract->>Contract: Check in State Created and NOT Landlord?
    Contract-->>Contract: Change State: Started
    Contract-->> Landlord: Agreement Confirmed Notification
    loop Pay Rents
    Tenant ->> Contract: Pay Rent
    Contract->>Landlord: Transfer Rent
    Contract-->> Landlord: Paid Rent notification
    end
    Landlord->> Contract: Terminate Contract
    Contract->>Contract: Check is Landlord?
    Contract-->> Tenant: Contract Terminated Notification
    Contract->> Landlord: Transfer Balance
    Contract-->>Contract: Change State: Terminated
```
