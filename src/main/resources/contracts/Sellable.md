...
Contract-->>Owner: Transfer Notification
Owner ->> Contract: initiateSale
Contract->>Contract:Check is Owner?
Contract-->>Contract: Set SellingTo, SellingPrice
opt Optional
Owner ->> Contract: cancelSale
end
Buyer->>Contract:completeSale
Contract->>Contract:Check is SellingPrice == Transfered Amount?
Contract-->>Contract:Swap ownership
Contract->>Owner: Transfer Selling Amount
Contract-->>Owner: Transfer Notification
```
